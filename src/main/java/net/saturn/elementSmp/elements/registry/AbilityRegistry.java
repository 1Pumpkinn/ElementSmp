package net.saturn.elementsmp.elements.registry;
...
import net.saturn.elementsmp.elements.abilities.impl.lightning.*;
...
public final class AbilityRegistry {
    ...
    private void registerAll() {
        ...
        // Lightning
        register(ElementType.LIGHTNING,
                new LightningSpeedAbility(plugin),
                new ThunderstormAbility(plugin)
        );
